...
![octoprint-plugin release](https://img.shields.io/github/v/release/bmelim/Octoprint-Printinfo?include_prereleases&label=octoprint-plugin)
![wordpress-plugin release](https://img.shields.io/github/v/release/bmelim/Octoprint-Printinfo?exclude_prereleases&label=wordpress-plugin)
